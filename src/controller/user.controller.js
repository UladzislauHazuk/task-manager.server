...
const { getUsers, getUsersById, updateUsers, deleteUser, patchUsers } = require('../services/user.service');
...
route.put('/:id', isValidUserId, isValidUser, isValidEmail, async (req, res) => {
  try {
    const { id } = req.params;
